...
class _GamesScreenState extends State<GamesScreen> {
  Offset possition = Offset(10, 300);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _showPopup == false ? Colors.white : Colors.grey,
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Stack(
              children: [
                AbsorbPointer(
                  absorbing: _showPopup == false ? false : true,
                  child: Column(
                    children: [
                      const SizedBox(
                        height: 20,
